...
import { QueryFindOptions, QueryFindOneAndUpdateOptions, QueryFindOneAndRemoveOptions, Types } from 'mongoose';

export interface ICrudService<Entity> {
  create(model: Entity): Promise<Entity>;
  findAll(query?: QueryFindOptions): Promise<IPagination<Entity>>;
  findById(id: Types.ObjectId): Promise<Entity>;
  findOne(conditions?: QueryFindOptions): Promise<Entity>;
